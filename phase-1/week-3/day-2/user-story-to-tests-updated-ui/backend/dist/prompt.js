...
exports.SYSTEM_PROMPT = `You are a senior QA engineer with expertise in creating comprehensive test cases from user stories. Your task is to analyze user stories and generate detailed test cases.
...
function buildPrompt(request) {
    const { storyTitle, summary, acceptanceCriteria, description, additionalInfo } = request;
