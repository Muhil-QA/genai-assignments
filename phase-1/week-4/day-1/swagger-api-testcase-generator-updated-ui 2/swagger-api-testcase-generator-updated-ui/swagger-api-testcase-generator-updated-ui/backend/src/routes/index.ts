...
import { correctSwagger, uploadSwagger, uploadSwaggerLink, validateSwagger } from "../controllers/swagger.controller.js";
...
apiRouter.post("/swagger/upload-link", uploadSwaggerLink);
