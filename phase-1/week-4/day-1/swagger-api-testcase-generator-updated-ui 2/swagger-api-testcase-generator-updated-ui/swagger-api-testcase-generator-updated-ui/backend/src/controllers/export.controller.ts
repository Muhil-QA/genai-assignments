...
import { summarizeTestCases } from "../services/testcase.service.js";
...
export const exportJson: RequestHandler = (req, res) => {
  ...
  res.type("application/json").send(JSON.stringify({ summary: summarizeTestCases(session.testCases), testCases: session.testCases }, null, 2));
};
