...
export function UploadPanel({ busy, onUpload, onClear, visible }: { busy: boolean; onUpload: (file: File) => void; onClear: () => void; visible: boolean }) {
    ...
    <section className="card upload-card">
      <div className="section-heading">
        <div>
          ...
          <p>Choose an OpenAPI YAML, YML, or JSON file from your device.</p>
        </div>
